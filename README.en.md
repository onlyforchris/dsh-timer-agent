...
Repo: [onlyforchris/dsh-timer-agent](https://github.com/onlyforchris/dsh-timer-agent) · Current version: `@onlyforchris/dsh-timer-agent@0.1.4`
...
```sh
dsh plugin --profile web add ./onlyforchris-dsh-timer-agent-0.1.4.tgz
```

After the package is published to npm, the exact version can also be installed directly:

```sh
dsh plugin --profile web add --save-exact @onlyforchris/dsh-timer-agent@0.1.4
```
